...
class bodyMetrics:
    def __init__(self, weight, height, age, impedance, sex):
        self.weight = weight
        self.height = height
        self.age = age
        self.sex = sex
    ...
    def getFatPercentage(self):
        ...
        if fatPercentage > 63:
            fatPercentage = 75
        # return self.checkValueOverflow(fatPercentage, 5, 75) # do not use, otherwise calculation error
    ...
    # Get BMI
    def getBMI(self):
        return self.weight / ((self.height / 100)**2)  # modified Peter Siebler
